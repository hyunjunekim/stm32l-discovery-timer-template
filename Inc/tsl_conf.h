...
/** Charge/transfer Period (in �s) (= high pulse + low pulse)
...
/** Delay for transfering charges from Cx to Cs capacitor and then discharge Cx
   (range=0..65535)
   - 0: no delay (it takes about 2.8�s for a CT cycle)
   - (1..65535): delay (in �s) = 0.75 * TSLPRM_DELAY_TRANSFER + 1
